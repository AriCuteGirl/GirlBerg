...
class Steam_Overlay
{
    ...
    int current_theme;
    int current_frontend;
    int current_ui_scale;
    bool theme_loaded;
    bool frontend_loaded;
    bool ui_scale_loaded;
    bool custom_context_open;
    uint64 custom_context_friend_id;
    float custom_context_x;
    float custom_context_y;
    ...
    std::unique_ptr<IOverlayFrontend> overlay_frontend;
    custom_ui::UiContext custom_ui_ctx;
    ...
    void SetupOverlayFrontend();
    void QueueFriendAction(Friend const& frd);
    void ProcessPendingFriendActions(class Steam_Friends* steamFriends, class Steam_Matchmaking* steamMatchmaking);
    void ProcessFriendActionFor(std::pair<const Friend, friend_window_state> &friend_info, class Steam_Friends* steamFriends, class Steam_Matchmaking* steamMatchmaking);
    ...
    void BuildFriendWindowCustomAero(Friend const& frd, friend_window_state &state);
...
public:
    ...
    void CreateFonts();
    void OverlayProc();
    void RenderOverlayWindows(ImGuiIO &io);
    void RenderCustomAeroOverlayWindows(ImGuiIO &io);
